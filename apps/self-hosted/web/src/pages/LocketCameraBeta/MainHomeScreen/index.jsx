  ...
  return (
    <>
      ...
      >
        ...
        />
        <div
          className={`w-full h-full flex flex-1 flex-col transition-all duration-500 justify-center items-center ${isBottomOpen ? "translate-x-0" : "fixed translate-y-full"
            }`}
        >
        ...
        <div
          className={`w-full h-full flex flex-col transition-all duration-500 justify-evenly items-center ${isBottomOpen ? "fixed -translate-y-full" : "translate-x-0"
            }`}
        >
          <div className="h-10" />
          <MediaPreview />
